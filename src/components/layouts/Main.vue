  ...
  <header class="flex justify-between items-center py-4 px-8 bg-orange-100 h-[60px]">
    ...
    <div class="w-[600px] flex flex-row justify-end">
      <div v-if="authStore.isLoggedIn" class="relative">
        <div
          class="p-2 rounded-xl bg-orange-200 flex items-center gap-2 cursor-pointer select-none"
        ...
        >
          ...
          <FontAwesomeIcon
            :icon="faChevronDown"
            :class="{ 'transform rotate-180 duration-300': isUserMenuDropdownOpen }"
            class="text-md"
          />
        </div>
        <div
          v-if="isUserMenuDropdownOpen"
        ...
        >
          ...
          <div
            class="flex items-center justify-end gap-2 text-right cursor-pointer"
            @click="onClickLogout"
