...
<template>
  <div class="w-full h-[calc(100vh-60px)] flex flex-col gap-4 items-center justify-center pt-4 px-2">
    ...
    <div class="flex flex-row size-full overflow-hidden">
      <div :class="slots.sidebar ? 'w-[75%]' : 'w-full'" class="overflow-y-auto tiny-scrollbar" data-testid="content">
        <slot name="content"></slot>
      </div>
      <div v-if="slots.sidebar" class="w-[25%] overflow-y-auto tiny-scrollbar" data-testid="sidebar">
